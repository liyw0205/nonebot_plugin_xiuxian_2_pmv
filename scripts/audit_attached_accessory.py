    ...
    try:
        ...
        return {
            ...
            "migration": {
                ...
                "name_valid": None if ledger is None else ledger[1] == ATTACHED_SCHEMA_NAME,
                "checksum_valid": None if ledger is None else ledger[2] == _checksum(),
                "metadata_valid": None if ledger is None else ledger[1] == ATTACHED_SCHEMA_NAME and ledger[2] == _checksum(),
