...
def _slice_status() -> dict[str, dict[str, object]]:
    ...
    return {
        ...
        "back": {
            ...
            "status": "cultivation_item_skill_learning_alchemy_unbind_repair_equipment_equip_unequip_pet_egg_package_accessory_package_cutover_with_other_back_compatibility",
        },
        "past_life": {
