...
def _slice_status() -> dict[str, dict[str, object]]:
    ...
    return {
        ...
        "admin": {
            ...
            "status": "item_destroy_exp_adjust_level_root_impart_stone_accessory_player_status_batch_item_batch_accessory_batch_cutover_with_admin_batch_compatibility",
        },
    }
