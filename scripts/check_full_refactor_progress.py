...
def _slice_status() -> dict[str, dict[str, object]]:
    ...
    return {
        ...
        "back": {
            ...
            "status": "cultivation_item_skill_learning_lottery_talisman_stone_reward_three_cultivation_pill_alchemy_unbind_repair_equipment_equip_unequip_pet_egg_package_accessory_package_affix_lock_unlock_decompose_batch_decompose_wash_upgrade_generic_item_use_cutover_with_other_back_compatibility",
        },
        "past_life": {
