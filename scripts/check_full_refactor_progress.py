...
def _slice_status() -> dict[str, dict[str, object]]:
    ...
    return {
        ...
        "rift": {
            ...
            "status": "entry_speedup_settlement_cutover_with_other_rift_compatibility",
        },
        "back": {
        ...
        "buff": {
            ...
            "status": "blessed_spot_open_rename_upgrade_stone_training_lifecycle_closing_settlement_cutover_with_other_buff_compatibility",
        },
        "impart": {
        ...
        "impart_pk": {
            ...
            "explore_replay_application_owned": "_impart_explore_settlement_service().settle(" in impart_pk_facade and "def _run_impart_pk_action(" in impart_pk_facade,
