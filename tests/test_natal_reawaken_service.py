...
from nonebot_plugin_xiuxian_2.xiuxian.xiuxian_natal_treasure.transaction_service import ReawakenService
from tests.test_db_backend import db_backend


class ReawakenServiceTests(unittest.TestCase):
    def test_natal_facade_defers_reawaken_service_construction(self):
        from nonebot_plugin_xiuxian_2.xiuxian import xiuxian_natal_treasure

        self.assertIsNone(xiuxian_natal_treasure._natal_reawaken_service_instance)
