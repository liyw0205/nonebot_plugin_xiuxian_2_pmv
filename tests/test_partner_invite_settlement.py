...
from nonebot_plugin_xiuxian_2.xiuxian.xiuxian_buff.transaction_service import PartnerInviteService
...
class PartnerInviteSettlementTests(unittest.TestCase):
    def test_partner_facade_defers_invite_service_construction(self):
        from nonebot_plugin_xiuxian_2.xiuxian.xiuxian_buff import partner

        self.assertIsNone(partner._partner_invite_service_instance)
