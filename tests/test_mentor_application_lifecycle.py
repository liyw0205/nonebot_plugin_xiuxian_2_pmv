...
from nonebot_plugin_xiuxian_2.xiuxian.xiuxian_buff.transaction_service import MentorApplicationService
from nonebot_plugin_xiuxian_2.xiuxian.xiuxian_buff.transaction_service import MentorBindService
