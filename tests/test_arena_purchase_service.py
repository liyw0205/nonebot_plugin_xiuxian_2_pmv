...
class ArenaPurchaseServiceTests(unittest.TestCase):
    ...
    def purchase(self, operation_id="purchase", **overrides):
        ...
        return self.service.purchase(operation_id, "user", 1, "item", "type", values["quantity"], values["unit_cost"], values["weekly_limit"], values["expected_honor"], values["weekly"], values["max_goods"], 1)
