...
class MentorBreakthroughRewardTests(unittest.TestCase):
    def test_partner_facade_defers_mentor_breakthrough_reward_service_construction(self):
        from nonebot_plugin_xiuxian_2.xiuxian.xiuxian_buff import partner

        self.assertIsNone(partner._mentor_breakthrough_reward_service_instance)
