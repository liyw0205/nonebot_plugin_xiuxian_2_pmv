...
class TiantiDataLazyReaderTests(unittest.TestCase):
    def test_tianti_data_defers_player_manager_construction(self):
        source = (
            Path(__file__).parents[1]
            / "nonebot_plugin_xiuxian_2/xiuxian/xiuxian_tianti/tianti_data.py"
