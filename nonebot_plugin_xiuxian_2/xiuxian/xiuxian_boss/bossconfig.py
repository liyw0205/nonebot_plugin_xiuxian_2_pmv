...
CONFIG = {
    ...
    "Boss灵石": {
        ...
        '遁一境': [12000000, 16000000, 21600000],
        '至尊境': [14000000, 18000000, 23600000],
        '真仙境': [16000000, 20000000, 25600000],
        '仙王境': [18000000, 22000000, 27600000],
        '准帝境': [20000000, 24000000, 29600000],
        '仙帝境': [22000000, 26000000, 31600000],
        '祭道境': [24000000, 28000000, 33600000],
        '自在境': [26000000, 30000000, 35600000],
        '破虚境': [28000000, 32000000, 37600000],
        '无界境': [30000000, 34000000, 39600000]                        
    },
    "Boss名字": [
        "九寒",
        "精卫",
