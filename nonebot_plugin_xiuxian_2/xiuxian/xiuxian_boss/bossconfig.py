...
CONFIG = {
    "open": {},
    "Boss灵石": {
        '搬血境': [50000, 70000, 98000],
        '洞天境': [100000, 140000, 196000],
        '化灵境': [200000, 280000, 392000],
        '铭纹境': [300000, 420000, 588000],
        '列阵境': [600000, 840000, 1176000],
        '尊者境': [1200000, 1680000, 2352000],
        '神火境': [2400000, 3360000, 4704000],
        '真一境': [8000000, 11200000, 15680000],
        '圣祭境': [18000000, 25200000, 35280000],
        '天神境': [34000000, 47600000, 66640000],
        '虚道境': [60000000, 84000000, 117600000],
        '斩我境': [100000000, 140000000, 196000000],
        '遁一境': [120000000, 160000000, 216000000],
        '至尊境': [140000000, 180000000, 236000000],
        '真仙境': [160000000, 200000000, 256000000],
        '仙王境': [180000000, 220000000, 276000000],
        '准帝境': [200000000, 240000000, 296000000],
        '仙帝境': [220000000, 260000000, 316000000],
        '祭道境': [240000000, 280000000, 336000000],
        '自在境': [260000000, 300000000, 356000000],
        '破虚境': [280000000, 320000000, 376000000],
        '无界境': [300000000, 340000000, 396000000]
    },
    "Boss名字": [
        "九寒",
        "精卫",
