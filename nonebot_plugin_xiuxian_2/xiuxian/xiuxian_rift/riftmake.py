...
TREASUREMSG = [
    ...
    "道友破解了秘境中的古老机关，获得了{}作为奖励！",
    "道友在秘境废墟中搜寻多时，终于在一处暗格中发现了{}",
    "秘境守护兽的巢穴中闪烁着奇异光芒，道友冒险潜入后得到了{}",
    "道友击败了守护宝物的傀儡，成功夺取了{}",
    "秘境中的神秘商人看你有缘，以极低价格出售给你{}",
    "道友在秘境祭坛上完成献祭仪式，获得了{}作为回报",
]

TREASUREMSG_1 = [
    "道友进入秘境后闯过了重重试炼，拿到了{}",
    "道友在秘境中历经九死一生，终于获得了{}",
    "道友解开了秘境中的上古谜题，获得了{}作为解答奖励",
    "秘境中的古老传承选择了你，赐予了{}",
    "道友在秘境核心区域发现了{}，周围散落着无数前辈的尸骨",
...
TREASUREMSG_2 = [
    ...
    "秘境中的藏书阁突然门户大开，道友趁机取走了{}",
    "一位垂死的前辈将毕生所学的{}传授予你后坐化",
    "道友在秘境古籍中发现了一张藏宝图，按图索骥找到了{}",
    "秘境中的石碑突然发光，将{}的内容直接印入你的脑海",
...
TREASUREMSG_3 = [
    ...
    "道友失望准备离开秘境时，踢到一块石头，下面压着{}",
    "秘境即将关闭的震动使岩壁剥落，露出了藏在其中的{}",
    "道友在最后一刻发现秘境中的暗门，匆忙间只带出了{}",
    "离开秘境时空间扭曲，一本{}突然掉入你怀中",
    "道友在秘境出口处被神秘力量阻拦，交出{}才被允许离开",
    "秘境中的幻象消散后，原地留下了{}",
    "道友的储物袋突然震动，不知何时多了一本{}",
]
...
TREASUREMSG_5 = [
    ...
    "秘境中的时空乱流将你卷入，等稳定下来时发现自己手中握着{}",
    "道友被秘境强制传送出来时，储物袋中莫名多了一本{}",
    "秘境关闭的最后一刻，一道灵光飞入你怀中，正是{}",
    "道友在秘境昏迷期间，似乎有人将{}塞入了你的衣襟",
    "离开秘境后整理收获时，才发现不知何时得到了{}",
