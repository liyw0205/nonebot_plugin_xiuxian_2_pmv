...
→ 传承力量 [数量] [道号] - 给指定用户发放或扣除思恋结晶
→ 创造力量 [物品] [数量] - 给自己发物品
→ 创造力量 [物品] [数量] all - 全服发物品
→ 创造力量 [物品] [数量] [道号] - 给指定用户发物品
→ 毁灭力量 [物品] [数量] - 给自己扣物品
→ 毁灭力量 [物品] [数量] all - 全服扣物品
→ 毁灭力量 [物品] [数量] [道号] - 给指定用户扣物品
→ 赠送称号 [称号] all - 全服赠送称号
...
→ 世界BOSS天罚 [编号] / 天罚世界BOSS [编号] - 删除指定BOSS
...
→ 点歌配置 查看 - 查看点歌配置
→ 点歌配置 设置 song_limit 10 - 设置单次点歌数量
...
→ 全局广播 [时间] [内容] - 群聊+私聊全局广播
   示例：群聊广播 1天 服务器将在今晚23:00维护
   时间格式：1天 / 1小时 / 1分钟 / 1天1小时10分钟；不填时默认1天
→ 查看广播 / 广播列表 - 查看当前广播任务
→ 取消广播 [广播ID] - 取消指定广播
