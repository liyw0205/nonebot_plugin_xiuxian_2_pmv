...
警告
- 此操作不可逆。所有修为、功法、神通、灵石、修炼等级、虚神界修炼时间将被清空。
- 散尽毕生修为后，可凝聚万世道果为极致天赋。

进入轮回
- 千世轮回
> 获得【轮回灵根】
  最低境界要求
  > {XiuConfig().lunhui_min_level}
- 万世轮回
> 获得【真·轮回灵根】
  最低境界要求
  > {XiuConfig().twolun_min_level}
- 永恒轮回
> 获得【永恒灵根】
  最低境界要求
  > {XiuConfig().threelun_min_level}
- 进入无限轮回
> 获得【命运灵根】
  最低境界要求
  > {XiuConfig().Infinite_reincarnation_min_level}
