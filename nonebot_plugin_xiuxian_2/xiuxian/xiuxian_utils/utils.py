...
from .message_markdown import (
    ...
    _looks_like_help_command,
    _command_candidates_from_help_text,
    _match_known_help_command,
    _link_single_help_command,
...
async def handle_send_native_markdown(
    bot,
    event,
    msg: str,
    button_id=None,
