    ...
    "anniversary": {
        ...
        "config": {
            ...
            "weekly_tasks": [
                ...
                _task_row("weekly_boss", "灵石x1200000,渡厄丹x1", name="伏魔庆典", target=40),
    ...
    "rank_warmup": {
        ...
        "config": {
            ...
            "weekly_tasks": [
                ...
                _task_row("weekly_boss", "灵石x300000", name="伏魔蓄势", target=40),
                _task_row("weekly_map_mission_complete", "灵石x250000", name="山河蓄势", target=10),
            ],
