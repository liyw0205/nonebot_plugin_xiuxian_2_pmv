...
sect_elixir_get = on_command("宗门丹药领取", aliases={"领取宗门丹药领取"}, priority=5, block=True)
...
加入宗门:加入一个宗门,需要带上宗门id
宗门职位变更:宗主可以改变宗门成员的职位等级【0 1 2 3 4】分别对应【宗主 长老 亲传 内门 外门】(外门弟子无法获得宗门修炼资源)
宗门捐献:建设宗门，提高宗门建设度，每{config["等级建设度"]}建设度会提高1级攻击/元血修炼等级上限
宗门改名:宗主可以改变宗门名称
退出宗门:退出当前宗门
踢出宗门:踢出对应宗门成员,需要输入正确的qq号或at对方
宗主传位:宗主可以传位宗门成员
升级攻击/元血/灵海修炼:升级道友的攻击/元血修炼等级,每级修炼等级提升4%攻击力/8%气血/5%真元,后可以接升级等级
宗门列表:查看所有宗门列表
...
宗门功法、神通搜寻:宗主可消耗宗门资材和宗门灵石来搜寻100次功法或者神通
学习宗门功法、神通:宗门成员可消耗宗门资材来学习宗门功法或者神通，后接功法名称
宗门功法查看:查看当前宗门已有的功法
