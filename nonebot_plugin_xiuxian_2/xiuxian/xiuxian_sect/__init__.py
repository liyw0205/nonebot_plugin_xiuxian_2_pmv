...
> 浏览天下宗门
- 创建宗门
> 耗 {XiuConfig().sect_create_cost} 灵石（须达 {XiuConfig().sect_min_level}）
- 加入宗门 [ID/名称]
> 求入指定宗门
- 退出宗门
> 离开本宗
...
**建设**
- 宗门捐献
> 增建设度（每 {config["等级建设度"]} 建设度，修炼上限 +1 级）
- 升级攻击/元血/灵海修炼
> 每级约 +4% 攻 / +8% 血 / +5% 真元
- 宗门炼体堂 / 宗门炼体堂升级
> 查阅与升级炼体堂
...
**事务**
- 宗门任务接取
> 日限 {config["每日宗门任务次上限"]} 次
- 宗门任务完成
> 交令（冷却 {config["宗门任务完成cd"]} 秒）
- 宗门任务刷新
> 换令（冷却 {config["宗门任务刷新cd"]} 秒）
- 宗门周常 / 领取宗门周常 / 宗门周常排行
> 全宗协作与领赏
- 宗门商店 / 宗门兑换 [物品] [数量]
> 以贡献兑换
