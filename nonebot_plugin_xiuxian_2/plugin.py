...
from .features.back.migrations import apply_alchemy, apply_back, apply_backpack_repair, apply_blessed_flag_replace, apply_breakthrough_rate_item, apply_cultivation_item, apply_equipment, apply_lottery_talisman, apply_permanent_atk_item, apply_recovery_item, apply_skill_learning, apply_stone_reward, apply_three_cultivation_pill, apply_unbind
