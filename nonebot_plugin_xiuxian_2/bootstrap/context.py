    ...
    if settings is None:
        ...
        config_service = ConfigService(
            (
                ...
                SettingDefinition("bank_first_use_interest_enabled", bool, default=False, reloadable=True, env_name="XIUXIAN_BANK_FIRST_USE_INTEREST_ENABLED", description="灵庄新结息路径灰度开关"),
                SettingDefinition("bank_first_use_withdrawal_enabled", bool, default=False, reloadable=True, env_name="XIUXIAN_BANK_FIRST_USE_WITHDRAWAL_ENABLED", description="灵庄新取款路径灰度开关"),
                SettingDefinition("bank_first_use_info_enabled", bool, default=False, reloadable=True, env_name="XIUXIAN_BANK_FIRST_USE_INFO_ENABLED", description="灵庄新信息查询路径灰度开关"),
