...
from .blueprints.bank_first_use import create_first_use_blueprint as bank_first_use_blueprint, create_info_blueprint as bank_info_first_use_blueprint, create_interest_blueprint as bank_interest_first_use_blueprint, create_upgrade_blueprint as bank_upgrade_first_use_blueprint
...
def create_app(
    *,
    ...
    if any(feature.key == "bank" for feature in registry.features):
        ...
        first_use_info = (context.services or {}).get("bank_first_use_info")
        if first_use_info is not None:
            app.register_blueprint(bank_info_first_use_blueprint(application=first_use_info, permission=has_permission))
