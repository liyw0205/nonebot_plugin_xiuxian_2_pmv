...
from .repository import ArenaRepository, LegacyArenaRepository
...
class ArenaApplication:
    def __init__(self, game_database: str | Path, player_database: str | Path, *, repository: ArenaRepository | None = None, ledger: OperationLedger | None = None) -> None:
    ...
    def _repository(self) -> ArenaRepository:
        return self.repository or LegacyArenaRepository(self.game_database, self.player_database)
