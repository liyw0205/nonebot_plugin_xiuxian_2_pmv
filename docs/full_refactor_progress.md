...
2026-09-20 buff blessed-spot open full verification：四个不重叠全量分片合计 `2394 passed, 25 subtests passed`（16条既有 compatibility DeprecationWarning）；verified batch结果为 `763/8`、`492/4`、`569/4`、`570/9`，所有精确 `/tmp` basetemp已清理。最终 blessed-spot open behavior/source、compileall、diff、inventory、progress和CLI均通过；洞天福地购买由 `BuffApplication.open`承载，保留 game/player transaction、灵石扣除、already-owned/stone-insufficient、operation replay/conflict和 rollback。
