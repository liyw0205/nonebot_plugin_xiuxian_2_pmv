...
**进度：首批高风险可变状态已于 2026-07-10 迁移到原子、带锁和损坏恢复的中央 Store。**
...
已完成补偿、邀请、互动、活动配置、相缘、扫雷、五子棋、十点半、宗门周购和工作奖励状态；
中央 Store 测试覆盖旧格式读取、根类型校验、损坏文件备份恢复、原子替换和并发读改写。
幻境状态体量较大，后续应先补独立 fixture 和行为测试，再按存档类型逐步迁移。
